...
{
	VA2.setPrimitiveType(Lines);
	Vector2f position(100, 500);
	for (float i(3); i < min(bufferSize / 2.f, 35.f); i *= 1.051)
	{
		Vector2f samplePosition(log(i) / log(min(bufferSize / 2.f, 20000.f)), abs(bin[(int)i]));
		VA2.append(Vertex(position + Vector2f(samplePosition.x * 500, -samplePosition.y / max * 500), Color::White));
		VA2.append(Vertex(position + Vector2f(samplePosition.x * 500, 0), Color::White));
		VA2.append(Vertex(position + Vector2f(samplePosition.x * 500, 0), Color::Color(255, 255, 255, 100)));
		VA2.append(Vertex(position + Vector2f(samplePosition.x * 500, samplePosition.y / max * 500 / 2.f), Color::Color(255, 255, 255, 0)));
	}
}
